/*7. Разработать сценарий, демонстрирующий на примере базы данных X_UNIVER утвер-ждение: AFTER-триггер является частью тран-закции, в рамках которого выполняется опера-тор, активизировавший триггер.*/
