/* 1. С помощью сценария, представленного на рисунке, создать таблицу TR_AUDIT.Таблица предназначена для добавления в нее строк триггерами.
...
go
    ...
    create  trigger TR_TEACHER_INS
	  ...
	  insert into  TEACHER values('ивФЫ1213', 'Иванов', 'м', 'ИСиТ');
